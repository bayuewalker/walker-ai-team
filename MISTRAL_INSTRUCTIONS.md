...
1. Read PROJECT_STATE.md (repo root) via GitHub connector
2. Read MISTRAL_KNOWLEDGE.md (repo root) — full reference for all roles
...
Done message:
"Done ✅ — [task name] complete. PR: feature/{feature}-{date}. Report: [phase]_[inc]_[name].md"
...
Done: "Done ✅ — GO-LIVE: [verdict]. Score: [X]/100. Critical: [N]. PR: main"
...
Done: "Done ✅ — Report: projects/.../reports/briefer/[file].html. PR: main
