...
**Last Updated:** 2026-05-04 06:22 Asia/Jakarta

## Build Path (Replit → Claude Code MVP)

| Lane | Name | Status | Tier | Notes |
|---|---|---|---|---|
| R1 | Skeleton — FastAPI + DB + Redis + Telegram polling + migrations | ✅ Complete | STANDARD | `WARP/crusaderbot-r1-skeleton` merged PR #847 |
| R2 | User onboarding + HD wallet generation | ❌ Not Started | MAJOR | — |
