...
2026-04-24 20:18 | NWAP/paper-core-foundation | Priority 3 paper-core foundation opened: added paper account persistence model, deterministic paper order lifecycle execution, baseline paper portfolio/risk runtime surfaces, targeted deterministic tests, and repo-truth state sync.
