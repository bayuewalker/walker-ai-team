...
- WARP🔹CMD: Priority 9 plan delivered. Scope individual WARP/{feature} lanes in recommended order: Lane 4 hygiene → Lanes 1+2 docs (parallel) → Lane 3 admin → Lane 5 final-acceptance (gated on P8 activation). Plan referenced in WARP/worktodo-priority8-sync forge report.
