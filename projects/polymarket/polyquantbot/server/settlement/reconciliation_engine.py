    ...
    def reconcile_single(self, entry: ReconciliationEntry) -> ReconciliationResult:
        ...
        if entry.internal_status == "" and entry.external_status is not None:
            ...
            return ReconciliationResult(
                ...
                repair_action=self._classify_repair_action(RECON_OUTCOME_ORPHAN, False),
                is_stuck=False,
                internal_status=entry.internal_status,
                external_status=entry.external_status,
        ...
        if entry.external_status is None and entry.internal_status == SETTLEMENT_STATUS_COMPLETED:
            ...
            return ReconciliationResult(
                ...
                repair_action=self._classify_repair_action(RECON_OUTCOME_MISSING, False),
                is_stuck=False,
                internal_status=entry.internal_status,
        ...
        if is_stuck:
            ...
            return ReconciliationResult(
                ...
                repair_action=self._classify_repair_action(RECON_OUTCOME_STUCK, True),
                is_stuck=True,
                internal_status=entry.internal_status,
                external_status=entry.external_status,
        ...
        return ReconciliationResult(
            ...
            repair_action=self._classify_repair_action(RECON_OUTCOME_MATCH, False),
            is_stuck=False,
            internal_status=entry.internal_status,
            external_status=entry.external_status,
        )
