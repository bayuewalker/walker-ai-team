# MISTRAL KNOWLEDGE FILE
# Walker AI Trading Team — Full Reference
# MISTRAL reads this file before every task via GitHub connector
...
- mark ALL critical systems as UNVERIFIED
...
"PENDING CODE REVIEW" means:

- system is NOT validated
- system is NOT safe
- must be treated as BLOCKED

Never interpret pending as pass

---

## ARCHITECTURE SCORING RULE

Without code verification:

max architecture score = 10/20
